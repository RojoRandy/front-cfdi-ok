<template>
  <div class="flex flex-col gap-2">
    ...
    <div ref="otpCont" class="flex flex-row gap-2 text-center">
      <input
        type="text"
        class="text-center w-full text-sm border-2 px-4 py-2 rounded-md text-theme-text placeholder:italic 
        hover:border-theme-interface focus:outline-none focus:ring-0"
