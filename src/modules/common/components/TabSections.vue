    ...
    <div class="flex flex-row border-b-2 pb-1 gap-4">
      ...
      <div class="flex-1 flex flex-col md:flex-wrap md:flex-row lg:gap-4 font-semibold">
        <span
          ...
          class="p-2 rounded-md flex-1 md:flex-none select-none
          hover:bg-theme-interface-secondary hover:text-theme-interface-secondary-foreground hover:cursor-pointer
          active:bg-theme-interface
          transition-all duration-200"
          :class="{
            'bg-theme-interface-secondary text-theme-interface-secondary-foreground text-center': section.isActive,
      ...
      <div
        ...
        class="flex flex-col gap-2 text-theme-interface-secondary-foreground z-30 bg-theme-interface-secondary rounded-lg p-4"
      >
        <span
          v-for="(section, index) in sections"
          @click="onSectionActive(index)"
          ...
          hover:bg-theme-interface transition-all duration-200 hover:cursor-pointer"
          :class="{
            'bg-theme-interface': section.isActive,
          }"
        >
          {{ section.text }}
        </span>
